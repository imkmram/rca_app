...
- (UIViewController *) controllerAtIndex:(NSInteger) index {
    ...
    if (![controllers objectForKey:[NSString stringWithFormat:@"%li",(long)index]]) {
        ...
        UIButton *btnPrev = [[UIButton alloc]initWithFrame:CGRectMake(5, 0, 40, headerSize * .9)];
        [btnPrev setTitle:@"Prev" forState:UIControlStateNormal];
        
        UIButton *btnNext = [[UIButton alloc]initWithFrame:CGRectMake(self.frame.size.width - 45 , 0, 40, headerSize * .9)];
        [btnNext setTitle:@"Next" forState:UIControlStateNormal];
        
        btnNext.backgroundColor = UIColor.blueColor;
        btnPrev.backgroundColor = UIColor.blueColor;
        
        UILabel *monthLabel = [[UILabel alloc]initWithFrame:CGRectMake(45, 0, self.frame.size.width - 80 -10, headerSize)];
        ...
        [contr.view addSubview:btnPrev];
        [contr.view addSubview:btnNext];
